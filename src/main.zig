...
pub fn main() !void {
    ...
    const vertex_shader = try Shader.init(allocator, "shaders/basic.vs", gl.VERTEX_SHADER);
    defer vertex_shader.deinit();

    const fragment_shader = try Shader.init(allocator, "shaders/basic.fs", gl.FRAGMENT_SHADER);
